...
namespace MLM.Data
{
    public static class DbInitializer
    {
        public static void Initialize(AppDBContext context)
        {
            ...
            {
                Console.WriteLine("Ã¢Å“â€¦ Super Admin already initialized.");
                return;
            }

            Console.WriteLine("Ã°Å¸Å¡â‚¬ Initializing Super Admin...");
            ...
            try
            {
                ...
                var menus = new[] {
                    ...
                    new NavigationItem { Name = "Change MT5 Password", Key = "change-mt5-password", Route = "/Account/ChangePassword", GroupId = myAccountGroup.Id, Sequence = 3 },
                    ...
                    new NavigationItem { Name = "MT5 To Wallet", Key = "mt5-to-wallet", Route = "/Wallet/Mt5ToWallet", GroupId = myWalletGroup.Id, Sequence = 2 },
                    new NavigationItem { Name = "Wallet To MT5", Key = "wallet-to-mt5", Route = "/Wallet/WalletToMt5", GroupId = myWalletGroup.Id, Sequence = 3 },
                    ...
                    new NavigationItem { Name = "Create MT5 Account", Key = "create-mt5", Route = "/User/CreateMt5", GroupId = userManagementGroup.Id, Sequence = 2 },
                    new NavigationItem { Name = "MT5 User List", Key = "mt5-user-list", Route = "/User/Mt5List", GroupId = userManagementGroup.Id, Sequence = 3 },
                    ...
                    new NavigationItem { Name = "Change MT5 Password", Key = "change-mt5-password", Route = "/User/ChangeMt5Password", GroupId = userManagementGroup.Id, Sequence = 13 },
                    new NavigationItem { Name = "Update MT5 Leverage", Key = "update-mt5-leverage", Route = "/User/UpdateLeverage", GroupId = userManagementGroup.Id, Sequence = 14 },
                    ...
                    new NavigationItem { Name = "Resend MT5 Data Mail", Key = "resend-data-mail", Route = "/User/ResendDataMail", GroupId = userManagementGroup.Id, Sequence = 16 },
                    ...
                    new NavigationItem { Name = "Update MT5 Group", Key = "update-mt5-group", Route = "/Group/UpdateMt5", GroupId = groupManagementGroup.Id, Sequence = 3 },
                ...
                transaction.Commit();
                Console.WriteLine("Ã¢Å“â€¦ Super Admin initialized successfully!");
            }
            catch (Exception ex)
            {
                transaction.Rollback();
                Console.WriteLine($"Ã¢ÂÅ’ Error initializing Super Admin: {ex.Message}");
                throw;
            }
        }
    }
